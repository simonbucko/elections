...
CREATE TABLE `candidates` (
  ...
  CONSTRAINT `fk_candidates_parties` FOREIGN KEY (`parties_id`) REFERENCES `parties` (`id`) ON UPDATE RESTRICT
...
INSERT INTO `candidates` VALUES (1,'Marcel Meijer',1),(2,'Michael Kristensen',1),(3,'Helle Hansen',1),(4,'Karina Knobelauch',2),(5,'Pia Ramsing',2),(6,'Per Urban Olsen',2),(7,'Louise Bramstorp',3),(8,'Ulla Holm',3),(9,'Lone Krag',3),(10,'Peter Mortensen',4),(11,'Vlad Garau',4),(12,'Anne Olsen',4),(20,'Simon',2),(22,'Simon',3);
...
INSERT INTO `votes` VALUES (28,'23456780',2),(26,'23456789',1);
...
-- Dump completed on 2021-12-21  1:32:41
